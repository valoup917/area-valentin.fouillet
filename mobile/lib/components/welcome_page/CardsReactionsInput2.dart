...
class CardReactionsInput2 extends StatefulWidget {
  const CardReactionsInput2({
    Key? key,
    required this.email,
    required this.image,
    required this.text,
  ...
  @override
  State<CardReactionsInput2> createState() => _CardReactionsInput2State();
}

class _CardReactionsInput2State extends State<CardReactionsInput2> {
                ...
                print("actionRoute : [${widget.actionRoute}]");
                  ...
                  http.post(
                    ...
                    body: jsonEncode(<String, String>{
                      ...
                      'reaction_data': '${controller1.text},${controller2.text}',
                    }),
                  );
